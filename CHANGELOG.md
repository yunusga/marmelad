...
### 💡 Стили и скрипты теперь поддерживают `.browserslistrc`

Стили и скрипты теперь поддерживают [.browserslistrc](https://github.com/browserslist/browserslist). Теперь стили и скрипты собираются с одинаковыми параметрами совместимости с браузерами указанными в `.browserslistrc`.
