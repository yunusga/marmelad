...
### Копирование исходников плагинов в `js/plugins`

Исходные стили и скрипты плагинов теперь копируются в `js/plugins` для более удобной работы в будущем или переподключении по требованию только того, что действительно необходимо.
